...
@WebServlet("/change-doctor-password")
public class ChangeDoctorPasswordServlet extends HttpServlet {

    private final doctorHandler handler = new doctorHandler();

    // Handle GET requests
    @Override
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        // Forward to a page with the change password form
        request.getRequestDispatcher("jsp/change-doctor-password.jsp").forward(request, response);
    }
