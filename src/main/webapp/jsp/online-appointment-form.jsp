...
<section class="max-w-2xl mx-auto my-8 p-5 bg-white rounded-lg shadow">
    ...
    <p class="text-red-600 text-center"><%= request.getAttribute("errorMessage") %></p>
    <% } %>
    <form id="appointmentForm" action="/online-book-appointment" method="post" class="space-y-4">
        <div>
            <label for="doctor" class="block font-semibold">Select Doctor</label>
            <select id="doctor" name="doctor" required class="border rounded w-full p-2">
