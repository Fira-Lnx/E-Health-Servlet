...
<section class="max-w-lg mx-auto my-10 p-6 bg-white rounded-lg shadow-md">
    <h2 class="text-2xl mb-4 text-center">Admin Login Form</h2>
    <form action="/admin-login" method="post">
        <div class="mb-4">
            <label for="Firstame" class="block mb-1">First Name*</label>
            <input type="text" id="firstName" name="name" required class="border border-gray-300 rounded px-3 py-2 w-full" />
        </div>
        <div class="mb-4">
