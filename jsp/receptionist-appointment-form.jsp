...
<header class="header">
    ...
    <nav class="main-nav">
        <ul>
            ...
            <li><a href="fetch-doctors">All Doctor</a></li>
            <li><a href="fetch-patients">All Patient</a></li>
            <li><a href="receptionist-book-appointment" class="active">Book Appointment</a></li>
...
<section class="form-section">
    ...
    <% } %>
    <form id="appointmentForm" action="/receptionist-book-appointment" method="post">
